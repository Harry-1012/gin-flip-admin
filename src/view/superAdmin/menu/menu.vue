<template>
  <div>
    <div class="gva-table-box">
     ...
     <el-dialog v-model="dialogFormVisible" :close-on-click-modal="false" :before-close="handleClose" :title="dialogTitle">
      ...
      <div>
        ...
        <el-table :data="form.menuBtn" style="width: 100%">
          <el-table-column align="center" prop="name" label="按钮名称" width="180">
            <template #default="scope">
              <div>
