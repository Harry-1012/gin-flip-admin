  ...
  <div>
    <div class="gva-table-box">
      ...
      <el-table :data="tableData" @sort-change="sortChange" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" label="包名" width="150" prop="packageName" />
        <el-table-column align="center" label="展示名" width="150" prop="label" />
        <el-table-column align="center" label="描述" min-width="150" prop="desc" />
     ...
     <el-dialog v-model="dialogFormVisible" :close-on-click-modal="false" :before-close="closeDialog" title="创建Package">
...
import {
  ...
  getPackageApi,
  deletePackageApi,
} from '@/api/system_tools/autoCode'
import { ref } from 'vue'
