      ...
      <el-collapse v-model="activeNames">
        <el-collapse-item title="系统配置" name="1">
          ...
          <el-form-item label="端口值">
            <el-input-number v-model.number="config.system.addr" />
          </el-form-item>
        ...
        <el-collapse-item title="Zap日志配置" name="3">
          <el-form-item label="级别">
            <el-input-number v-model.number="config.zap.level" />
          </el-form-item>
        ...
        <el-collapse-item title="邮箱配置" name="5">
          ...
          <el-form-item label="端口">
            <el-input-number v-model.number="config.email.port" />
          </el-form-item>
        ...
        <el-collapse-item title="验证码配置" name="7">
          <el-form-item label="keyLong">
            <el-input-number v-model.number="config.captcha.keyLong" />
          </el-form-item>
          <el-form-item label="imgWidth">
            <el-input-number v-model.number="config.captcha.imgWidth" />
          </el-form-item>
          <el-form-item label="imgHeight">
            <el-input-number v-model.number="config.captcha.imgHeight" />
          </el-form-item>
        </el-collapse-item>
        <el-collapse-item title="数据库配置" name="9">
          <template v-if="config.system.dbType === 'mysql'">
            ...
            <el-form-item label="maxIdleConns">
              <el-input-number v-model.number="config.mysql.maxIdleConns" />
            </el-form-item>
            <el-form-item label="maxOpenConns">
              <el-input-number v-model.number="config.mysql.maxOpenConns" />
            </el-form-item>
          ...
          <template v-if="config.system.dbType === 'pgsql'">
            ...
            <el-form-item label="maxIdleConns">
              <el-input-number v-model.number="config.pgsql.maxIdleConns" />
            </el-form-item>
            <el-form-item label="maxOpenConns">
              <el-input-number v-model.number="config.pgsql.maxOpenConns" />
            </el-form-item>
            <el-form-item label="logMode">
...
import { emailTest } from '@/api/utils/email'
