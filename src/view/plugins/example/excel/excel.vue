<template>
  <div class="upload">
    <div class="btn-list">
      ...
      <el-button class="excel-btn" size="small" type="primary"  @click="handleExcelExport('ExcelExport.xlsx')">导出</el-button>
      <el-button class="excel-btn" size="small" type="success"  @click="downloadExcelTemplate()">下载模板</el-button>
    </div>
...
import { exportExcel, loadExcelData, downloadTemplate } from '@/api/utils/excel'
